...
public class EnergyPowerScreen extends PowerScreen {
    ...
    public void initContents() {
        ...
        addPowerIcon(new PowerButton(tabWidth/2 + 67, height/2 + 30, OPPowers.CASUALIDADE_FORTUITA));
        addPowerIcon(new PowerButton(tabWidth/2 - 13, height/2 + 30, OPPowers.SOBRECARGA));
    }
}
