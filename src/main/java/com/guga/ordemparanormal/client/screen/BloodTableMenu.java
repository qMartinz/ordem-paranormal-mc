...
import com.guga.ordemparanormal.client.screen.slot.OPResultSlot;
...
public class BloodTableMenu extends AbstractContainerMenu {
    ...
    public BloodTableMenu(int id, Inventory inv, BlockEntity entity) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(cap -> {
            this.addSlot(new SlotItemHandler(cap, 0, 34, 40));
            this.addSlot(new SlotItemHandler(cap, 1, 57, 18));
            this.addSlot(new SlotItemHandler(cap, 2, 103, 18));
            this.addSlot(new OPResultSlot(cap, 3, 80, 60));
        });
    }
