...
public class ZumbiSangueModel<T extends ZumbiSangue> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		leftlowerleg.addOrReplaceChild("leftfoot", CubeListBuilder.create().texOffs(14, 21).addBox(-2.0F, -0.0331F, -4.3274F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.5744F, 0.1173F, -0.041F, -0.0417F, 0.0447F));
		...
		rightlowerleg.addOrReplaceChild("rightfoot", CubeListBuilder.create().texOffs(18, 5).addBox(-2.0F, -0.0331F, -4.3274F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.7244F, -0.2327F, -0.7423F, 0.0427F, -0.0741F));
		...
		leftarm.addOrReplaceChild("leftforearm", CubeListBuilder.create().texOffs(28, 21).addBox(-0.1453F, -1.5F, -1.4073F, 7.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.7901F, -0.4447F, -0.0579F, -1.1581F, 1.2393F, -1.1783F));
		...
		rightarm.addOrReplaceChild("rightforearm", CubeListBuilder.create().texOffs(0, 28).addBox(-6.8547F, -1.5F, -1.4073F, 7.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.7901F, -0.4447F, -0.0579F, 0.0F, -0.7854F, 0.0F));
