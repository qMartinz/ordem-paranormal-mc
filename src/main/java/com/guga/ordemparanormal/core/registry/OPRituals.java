...
public class OPRituals {
    ...
    public static final AbstractRitual ARMADURA_SANGUE = new ArmaduraSangue("armadura_sangue", ParanormalElement.SANGUE,
            1, 3, true, 0, true);
    public static final AbstractRitual DESCARNAR = new Descarnar("descarnar", SANGUE, 1, 2, true, 5D, true);
    public static final AbstractRitual HEMOFAGIA = new Hemofagia("hemofagia", ParanormalElement.SANGUE, 2, 4, true, 5D,
            true);
    ...
    // Morte
    public static final AbstractRitual CICATRIZACAO = new Cicatrizacao("cicatrizacao", ParanormalElement.MORTE, 1, 2,
            true, 3.5D, true);
    ...
    public static final AbstractRitual SALTO_FANTASMA = new SaltoFantasma("salto_fantasma", ParanormalElement.ENERGIA,
            3, 6, false, 15D, true);
    public static final AbstractRitual TELEPORTE = new Teleporte("teleporte", ParanormalElement.ENERGIA, 4, 8, true, 2D,
            true);
    public static final AbstractRitual LUZ = new Luz("luz", ParanormalElement.ENERGIA, 1, 1, false, 5D, true);
    public static final AbstractRitual TRANSFIGURAR_AGUA = new TransfigurarAgua("transfigurar_agua",
    ...
    public static final AbstractRitual PERTURBACAO = new Perturbacao("perturbacao", ParanormalElement.CONHECIMENTO, 1,
            1, true, 3D, true);
    ...
    // Medo
    public static final AbstractRitual MEDO_TANGIVEL = new MedoTangivel("medo_tangivel", ParanormalElement.MEDO, 4, 8,
            true, 0d, false);
