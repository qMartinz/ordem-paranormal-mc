...
public class OPRituals {
        ...
        public static final AprimoramentoFisico APRIMORAMENTO_FISICO = new AprimoramentoFisico(
                        new ResourceLocation(MOD_ID, "aprimoramento_fisico"), ParanormalElement.SANGUE, 2, 4, 0D,
                        true);
        ...
        public static final Hemofagia HEMOFAGIA = new Hemofagia(new ResourceLocation(MOD_ID, "hemofagia"),
                        ParanormalElement.SANGUE, 2, 4, 7.5D,
                        true);
        public static final TransferenciaVital TRANSFERENCIA_VITAL = new TransferenciaVital(
                        new ResourceLocation(MOD_ID, "transferencia_vital"), ParanormalElement.SANGUE, 2, 4, 7.5D,
                        true);
        // Morte
        ...
        public static final ConsumirManancial CONSUMIR_MANANCIAL = new ConsumirManancial(
                        new ResourceLocation(MOD_ID, "consumir_manancial"), ParanormalElement.MORTE, 1, 3, 0D,
                        true);
        ...
        public static final VelocidadeMortal VELOCIDADE_MORTAL = new VelocidadeMortal(
                        new ResourceLocation(MOD_ID, "velocidade_mortal"), ParanormalElement.MORTE, 2, 4, 0D,
                        true);
        public static final EspiraisDaPerdicao ESPIRAIS_DA_PERDICAO = new EspiraisDaPerdicao(
                        new ResourceLocation(MOD_ID, "espirais_da_perdicao"), ParanormalElement.MORTE, 1, 2, 7.5D,
                        true);
        public static final ZerarEntropia ZERAR_ENTROPIA = new ZerarEntropia(
                        new ResourceLocation(MOD_ID, "zerar_entropia"), ParanormalElement.MORTE, 3, 6, 7.5D,
                        true);
        public static final EcoEspiral ECO_ESPIRAL = new EcoEspiral(
                        new ResourceLocation(MOD_ID, "eco_espiral"), ParanormalElement.MORTE, 2, 4, 7.5D,
                        true);
        // Energia
        ...
        public static final SaltoFantasma SALTO_FANTASMA = new SaltoFantasma(
                        new ResourceLocation(MOD_ID, "salto_fantasma"), ParanormalElement.ENERGIA, 3, 6, 17.5D,
                        true);
        public static final Teleporte TELEPORTE = new Teleporte(new ResourceLocation(MOD_ID, "teleporte"),
                        ParanormalElement.ENERGIA, 4, 8, 2D, true);
        public static final Luz LUZ = new Luz(new ResourceLocation(MOD_ID, "luz"), ParanormalElement.ENERGIA,
                        1, 1, 7.5D, true);
        public static final TransfigurarTerra TRANSFIGURAR_TERRA = new TransfigurarTerra(
                        new ResourceLocation(MOD_ID, "transfigurar_terra"), ParanormalElement.ENERGIA, 3, 6, 7.5D,
                        true);
        // Conhecimento
        ...
        public static final Perturbacao PERTURBACAO = new Perturbacao(new ResourceLocation(MOD_ID, "perturbacao"),
                        ParanormalElement.CONHECIMENTO, 1, 1, 7.5D, true);
        public static final Inexistir INEXISTIR = new Inexistir(new ResourceLocation(MOD_ID, "inexistir"),
                        ParanormalElement.CONHECIMENTO, 4, 8, 7.5D, true);
        public static final AlterarMemoria ALTERAR_MEMORIA = new AlterarMemoria(
                        new ResourceLocation(MOD_ID, "alterar_memoria"), ParanormalElement.CONHECIMENTO, 3, 6, 7.5D,
                        true);
        // Medo
        ...
        public static final Cineraria CINERARIA = new Cineraria(
                        new ResourceLocation(MOD_ID, "cineraria"), ParanormalElement.MEDO, 1, 2, 0d, false);
        public static final RejeitarNevoa REJEITAR_NEVOA = new RejeitarNevoa(
                        new ResourceLocation(MOD_ID, "rejeitar_nevoa"), ParanormalElement.MEDO, 2, 4, 0d,
                        false);
