...
public interface IRitualCaster {
    ...
    default InteractionResultHolder<ItemStack> castRitual(Level world, Player player, InteractionHand hand, @Nonnull AbstractRitual ritual){
        ItemStack stack = player.getItemInHand(hand);
        HitResult result = RitualUtils.rayTrace(player, 5, 0, false);
