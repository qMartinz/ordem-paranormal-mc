...
public class Mansion extends Structure {
    public static final Codec<Mansion> CODEC = RecordCodecBuilder.<Mansion>mapCodec(instance ->
            instance.group(Mansion.settingsCodec(instance),
            ...
            ).apply(instance, Mansion::new)).codec();
    ...
    public Mansion(StructureSettings config, Holder<StructureTemplatePool> startPool,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        if (!Mansion.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return OPStructures.MANSION.get();
    }
}