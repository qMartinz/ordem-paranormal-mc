...
public class Crypt extends Structure {
    public static final Codec<Crypt> CODEC = RecordCodecBuilder.<Crypt>mapCodec(instance ->
            instance.group(Crypt.settingsCodec(instance),
            ...
            ).apply(instance, Crypt::new)).codec();
    ...
    public Crypt(StructureSettings config, Holder<StructureTemplatePool> startPool,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        if (!Crypt.extraSpawningChecks(context)) {
