...
public class DevilChurch extends Structure {
    public static final Codec<DevilChurch> CODEC = RecordCodecBuilder.<DevilChurch>mapCodec(instance ->
            instance.group(DevilChurch.settingsCodec(instance),
            ...
            ).apply(instance, DevilChurch::new)).codec();
    ...
    public DevilChurch(StructureSettings config, Holder<StructureTemplatePool> startPool,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        if (!DevilChurch.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return OPStructures.DEVIL_CHURCH.get();
    }
}