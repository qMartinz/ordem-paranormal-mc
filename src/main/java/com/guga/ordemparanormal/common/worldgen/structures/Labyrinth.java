...
public class Labyrinth extends StructureFeature<JigsawConfiguration> {
    ...
    public Labyrinth() {
        super(CODEC, Labyrinth::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    @Override
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!Labyrinth.isFeatureChunk(context)) {
