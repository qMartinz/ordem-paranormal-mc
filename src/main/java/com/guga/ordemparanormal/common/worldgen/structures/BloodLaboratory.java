...
public class BloodLaboratory extends Structure {
    public static final Codec<BloodLaboratory> CODEC = RecordCodecBuilder.<BloodLaboratory>mapCodec(instance ->
            instance.group(BloodLaboratory.settingsCodec(instance),
            ...
            ).apply(instance, BloodLaboratory::new)).codec();
    ...
    public BloodLaboratory(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool,
    ...
    private static boolean extraSpawningChecks(Structure.GenerationContext context) {
        ...
        boolean flag1 = context.chunkGenerator().hasStructureChunkInRange(StructureSets.VILLAGES, context.randomState(),
                context.seed(), chunkpos.x, chunkpos.z, 12);

        return flag1;
    }
    @Override
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        if (!BloodLaboratory.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return OPStructures.BLOOD_LABORATORY.get();
    }
}