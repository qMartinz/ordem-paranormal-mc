...
public class Perturbacao extends AbstractRitual implements OffensiveRitual {
    ...
    public void onUseEntity(EntityHitResult rayTraceResult, Level world, LivingEntity caster,
        ...
        MobEffectInstance disturbed = new MobEffectInstance(OPEffects.DISTURBED.get(), 200, 0, false, false);
