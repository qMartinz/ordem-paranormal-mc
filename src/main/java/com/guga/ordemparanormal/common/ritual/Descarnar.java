...
public class Descarnar extends AbstractRitual implements OffensiveRitual {
    public Descarnar(ResourceLocation id, ParanormalElement element, int tier, int effortCost, double range, boolean mustHoldIngredient) {
