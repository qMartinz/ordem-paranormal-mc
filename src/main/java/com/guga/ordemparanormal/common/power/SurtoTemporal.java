...
public class SurtoTemporal extends PlayerPower {
    public SurtoTemporal(String id, boolean isActivePower, ParanormalElement element, int effortCost, int nexRequired, int[] attributesRequired, PlayerPower... powerRequirements) {
