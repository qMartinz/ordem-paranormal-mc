...
public class PunhoEnraivecido extends PlayerPower {
    public PunhoEnraivecido(String id, boolean isActivePower, ParanormalElement element, int effortCost, int nexRequired, int[] attributesRequired, PlayerPower... powerRequirements) {
