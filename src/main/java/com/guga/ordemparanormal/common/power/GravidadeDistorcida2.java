...
public class GravidadeDistorcida2 extends PlayerPower {
    public GravidadeDistorcida2(ResourceLocation id, boolean isActivePower, ParanormalElement element, int effortCost, int nexRequired, int[] attributesRequired, PlayerPower... powerRequirements) {
