...
public class PerimetroEspiral extends PlayerPower {
    public PerimetroEspiral(ResourceLocation id, ParanormalElement element, int cost, int nex, int[] attributes, PlayerPower... powers) {
    ...
    public void onUse(Player player) {
        ...
        targets.removeIf(entity -> entity == player || (entity instanceof ParanormalCreature creature && creature.getElement() == ParanormalElement.ENERGIA));
